...
class Details extends Component
{
    ...
    {
        try {
            $serviceType = Category::findOrFail($id);
            if (!$serviceType) {
    ...
    public function updatePost()
    {
        ...
        try {
            Category::whereId($this->serviceTypeId)->update($validatedData);
    ...
    {
        $data = Category::findOrFail($this->dataId);
        $data->delete();
